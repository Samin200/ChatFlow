...
['novalink_token', 'chatflow_token', 'kothaboli_token', 'auth_token', 'token'].forEach(k => migrate(k, 'nChatFlow_token'));
['novalink_user', 'chatflow_user', 'kothaboli_user', 'auth_user', 'user'].forEach(k => migrate(k, 'nChatFlow_user'));

    ...
    <div className="space-y-3">
      <div className="rounded-xl border p-3 space-y-3" style={{ borderColor: "color-mix(in srgb, var(--color-text) 14%, transparent)", backgroundColor: "color-mix(in srgb, var(--color-surface) 88%, transparent)" }}>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-sm">
          <label className="flex items-center gap-2 rounded-lg border px-2 py-2" style={{ color: "var(--color-text)", borderColor: "color-mix(in srgb, var(--color-text) 14%, transparent)" }}>
            <input
              type="radio"
              name="theme-mode"
      ...
      <button
        onClick={() => onToggleChatSide?.(panel.contactId)}
      ...
      >
        Toggle Chat Sides ({panel.appearance?.chatSide ?? "default"})
      </button>
